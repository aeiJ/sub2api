export default {
    settings: {
      ...
      openaiExperimentalScheduler: {
        ...
        priorityDrainTitle: 'Priority quota drain',
        priorityDrainDescription: 'Consumes OpenAI OAuth and setup-token accounts strictly by priority before API Keys. Slow API Keys enter a temporary soft cooldown.',
        priorityDrainTakenOver: 'Sticky weighting and subscription priority are managed by priority quota drain while enabled; existing sessions keep hard affinity.',
        ttftThreshold: 'TTFT threshold (seconds)',
        slowCount: 'Consecutive slow results',
        statisticsWindow: 'Slow-result window (seconds)',
        softCooldown: 'Soft cooldown (seconds)',
