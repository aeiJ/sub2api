export default {
    settings: {
      ...
      openaiExperimentalScheduler: {
        ...
        priorityDrainTitle: '优先额度消耗',
        priorityDrainDescription: '严格按优先级消耗 OpenAI OAuth 和 setup-token，再回退 API Key；慢速 API Key 会进入临时软冷却。',
        priorityDrainTakenOver: '启用优先额度消耗后，粘性加权和订阅优先均由该策略接管；已有会话仍保持硬粘性。',
        ttftThreshold: 'TTFT 阈值（秒）',
        slowCount: '连续慢速次数',
        statisticsWindow: '慢速统计窗口（秒）',
        softCooldown: '软冷却时长（秒）',
        weightsTitle: '调度权值覆盖',
