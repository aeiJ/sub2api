...
const (
	...
	// SettingKeyOpenAIPriorityDrainEnabled enables strict OpenAI OAuth/API Key
	// priority ordering (with setup-token following OAuth) in place of
	// subscription-pool Top-K selection.
	SettingKeyOpenAIPriorityDrainEnabled                    = "openai_priority_drain_enabled"
	SettingKeyOpenAIPriorityDrainTTFTThresholdSeconds       = "openai_priority_drain_ttft_threshold_seconds"
	SettingKeyOpenAIPriorityDrainConsecutiveSlowCount       = "openai_priority_drain_consecutive_slow_count"
	SettingKeyOpenAIPriorityDrainStatisticsWindowSeconds    = "openai_priority_drain_statistics_window_seconds"
	SettingKeyOpenAIPriorityDrainSoftCooldownSeconds        = "openai_priority_drain_soft_cooldown_seconds"
