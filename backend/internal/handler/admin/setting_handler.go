...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		OpenAIPriorityDrainEnabled:                             settings.OpenAIPriorityDrainEnabled,
		OpenAIPriorityDrainTTFTThresholdSeconds:                settings.OpenAIPriorityDrainTTFTThresholdSeconds,
		OpenAIPriorityDrainConsecutiveSlowCount:                settings.OpenAIPriorityDrainConsecutiveSlowCount,
		OpenAIPriorityDrainStatisticsWindowSeconds:             settings.OpenAIPriorityDrainStatisticsWindowSeconds,
		OpenAIPriorityDrainSoftCooldownSeconds:                 settings.OpenAIPriorityDrainSoftCooldownSeconds,
